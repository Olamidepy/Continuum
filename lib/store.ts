  ...
  persist(
    (set, get) => ({
      ...
      transactions: [
        {
          id: 'tx-20',
          txId: '0x3a1b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b',
          type: 'create',
          vaultId: 1,
          assetType: 'STX',
          amount: 5000 * 1_000_000,
          timestamp: Date.now() - 3900000000,
          status: 'success',
          durationBlocks: 12960,
          network: 'Stacks',
        },
        {
          id: 'tx-19',
          txId: '0x4b2c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c',
          type: 'create',
          vaultId: 2,
          assetType: 'sBTC',
          amount: 0.5 * 100_000_000,
          timestamp: Date.now() - 3600000000,
          status: 'success',
          durationBlocks: 52560,
          network: 'Stacks',
        },
        {
          id: 'tx-18',
          txId: '0x5c3d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d',
          type: 'create',
          vaultId: 3,
          assetType: 'STX',
          amount: 2000 * 1_000_000,
          timestamp: Date.now() - 3300000000,
          status: 'success',
          durationBlocks: 4320,
          network: 'Stacks',
        },
        {
          id: 'tx-17',
          txId: '0x6d4e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e',
          type: 'deposit',
          vaultId: 1,
          assetType: 'STX',
        ...
        {
          id: 'tx-16',
          txId: '0x7e5f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f',
          type: 'claim',
          vaultId: 1,
          assetType: 'STX',
          amount: 50 * 1_000_000,
          timestamp: Date.now() - 2700000000,
          status: 'success',
          network: 'Stacks',
        },
        {
          id: 'tx-15',
          txId: '0x8f6a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a',
          type: 'create',
          vaultId: 4,
          assetType: 'STX',
          amount: 2500 * 1_000_000,
          timestamp: Date.now() - 2400000000,
          status: 'success',
          durationBlocks: 25920,
          network: 'Celo',
        },
        {
          id: 'tx-14',
          txId: '0x9a7b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b',
          type: 'extend',
          vaultId: 2,
          assetType: 'sBTC',
          amount: 0,
          timestamp: Date.now() - 2100000000,
          status: 'success',
          durationBlocks: 52560,
          network: 'Stacks',
        },
        {
          id: 'tx-13',
          txId: '0xa88c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c',
          type: 'claim',
          vaultId: 2,
          assetType: 'sBTC',
          amount: 0.005 * 100_000_000,
          timestamp: Date.now() - 1800000000,
          status: 'success',
          network: 'Stacks',
        },
        {
          id: 'tx-12',
          txId: '0xb99d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d',
          type: 'deposit',
          vaultId: 4,
          assetType: 'STX',
          amount: 500 * 1_000_000,
        ...
        {
          id: 'tx-11',
          txId: '0xca0e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e',
          type: 'withdraw',
          vaultId: 4,
          assetType: 'STX',
          amount: 3000 * 1_000_000,
        ...
        {
          id: 'tx-10',
          txId: '0xdb1f8a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f',
          type: 'create',
          vaultId: 5,
          assetType: 'STX',
        ...
        {
          id: 'tx-9',
          txId: '0xec2a9b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a',
          type: 'claim',
          vaultId: 1,
          assetType: 'STX',
          amount: 75 * 1_000_000,
        ...
        {
          id: 'tx-8',
          txId: '0xfd3b0c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b',
          type: 'create',
          vaultId: 6,
          assetType: 'sBTC',
          amount: 0.25 * 100_000_000,
        ...
        {
          id: 'tx-7',
          txId: '0x0e4c1d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c',
          type: 'deposit',
          vaultId: 3,
          assetType: 'STX',
          amount: 500 * 1_000_000,
        ...
        {
          id: 'tx-6',
          txId: '0x1f5d2e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d',
          type: 'emergency',
          vaultId: 5,
          assetType: 'STX',
          amount: 1500 * 1_000_000,
        ...
        {
          id: 'tx-5',
          txId: '0x2a6e3f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e',
          type: 'claim',
          vaultId: 3,
          assetType: 'STX',
          amount: 45 * 1_000_000,
        ...
        {
          id: 'tx-4',
          txId: '0x3b7f4a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f',
          type: 'extend',
          vaultId: 1,
          assetType: 'STX',
          amount: 0,
        ...
        {
          id: 'tx-3',
          txId: '0x4c8a5b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a',
          type: 'deposit',
          vaultId: 2,
          assetType: 'sBTC',
          amount: 0.1 * 100_000_000,
        ...
        {
          id: 'tx-2',
          txId: '0x5d9b6c7d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b',
          type: 'claim',
          vaultId: 2,
          assetType: 'sBTC',
          amount: 0.01 * 100_000_000,
        ...
        {
          id: 'tx-1',
          txId: '0x6ea07d8e9f0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c',
          type: 'withdraw',
          vaultId: 3,
          assetType: 'STX',
          amount: 2000 * 1_000_000,
